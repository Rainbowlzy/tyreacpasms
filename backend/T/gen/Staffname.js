    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveStaffname", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"Staffname.html?table=Staffname"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetStaffnameEmpty", {}, function(data) {
					data = data||{};
					data.table = 'Staffname'
					vm = new Vue({
						el: "#Staffname",
						data: data||{},
						computed:{
				...
				$.call("GetStaffnameList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
