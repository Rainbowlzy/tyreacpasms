    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveSupplier", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"Supplier.html?table=Supplier"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetSupplierEmpty", {}, function(data) {
					data = data||{};
					data.table = 'Supplier'
					vm = new Vue({
						el: "#Supplier",
				...
				$.call("GetSupplierList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
