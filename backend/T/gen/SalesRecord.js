    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveSalesRecord", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"SalesRecord.html?table=SalesRecord"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetSalesRecordEmpty", {}, function(data) {
					data = data||{};
					data.table = 'SalesRecord'
					vm = new Vue({
						el: "#SalesRecord",
						data: data||{},
						computed:{
				...
				$.call("GetSalesRecordList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
