    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveWarehousingRecord", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"WarehousingRecord.html?table=WarehousingRecord"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetWarehousingRecordEmpty", {}, function(data) {
					data = data||{};
					data.table = 'WarehousingRecord'
					vm = new Vue({
						el: "#WarehousingRecord",
						data: data||{},
						computed:{
							request:function(){
								return GetRequest();
				...
				$.call("GetWarehousingRecordList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
