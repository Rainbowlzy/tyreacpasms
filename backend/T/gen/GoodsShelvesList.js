...
$(document).ready(function(){
		var vm = new Vue({
			...
			mounted:function(){
				...
				var $table = $("#tableGoodsShelves")
				//表格传区域ID参数
				var url = "";
				$table.attr("data-url", "/T/DefaultHandler.ashx?method=getGoodsShelvesList&data=" + JSON.stringify(GetRequest()) + "&");
				console.log($.buildColumns({"debug":null,"Columns":[{"column_name":"GSShelfNumber","column_description":"货架编号","dbtype":"NVARCHAR(50)","max_length":0,"pascal_column_name":"ShelfNumber"},{"column_name":"GSVolume","column_description":"容积 ","dbtype":"NVARCHAR(50)","max_length":0,"pascal_column_name":"Volume"},{"column_name":"GSLocation","column_description":"位置","dbtype":"NVARCHAR(50)","max_length":0,"pascal_column_name":"Location"},{"column_name":"GSResponsibleForManualNumber","column_description":"负责人工号","dbtype":"NVARCHAR(50)","max_length":0,"pascal_column_name":"ResponsibleForManualNumber"}],"Children":null,"Parent":null,"r":null,"table_name":"GoodsShelves","table_name_en":"GoodsShelves","table_name_ch":"货架","column_name":null,"column_description":null,"dbtype":null,"max_length":0}));
