    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveUserRole", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"UserRole.html?table=UserRole"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetUserRoleEmpty", {}, function(data) {
					data = data||{};
					data.table = 'UserRole'
					vm = new Vue({
						el: "#UserRole",
				...
				$.call("GetUserRoleList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
