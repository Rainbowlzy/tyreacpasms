    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveWarehouse", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"Warehouse.html?table=Warehouse"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetWarehouseEmpty", {}, function(data) {
					data = data||{};
				...
				$.call("GetWarehouseList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
