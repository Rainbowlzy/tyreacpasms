    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveOrderDetails", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"OrderDetails.html?table=OrderDetails"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetOrderDetailsEmpty", {}, function(data) {
					data = data||{};
				...
				$.call("GetOrderDetailsList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
