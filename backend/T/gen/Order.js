    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveOrder", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"Order.html?table=Order"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetOrderEmpty", {}, function(data) {
					data = data||{};
					data.table = 'Order'
					vm = new Vue({
						el: "#Order",
				...
				$.call("GetOrderList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
