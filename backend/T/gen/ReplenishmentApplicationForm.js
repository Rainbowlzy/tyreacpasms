...
require([
    ...
    $(document).ready(function() {
        ...
        var created = function () {
			...
			$("#ReplenishmentApplicationForm").show();
        };
        var method = {
			log(o){
				(o)
            ...
            save() {
                ...
                $.call("SaveReplenishmentApplicationForm", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"ReplenishmentApplicationForm.html?table=ReplenishmentApplicationForm"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetReplenishmentApplicationFormEmpty", {}, function(data) {
					data = data||{};
					data.table = 'ReplenishmentApplicationForm'
					vm = new Vue({
						el: "#ReplenishmentApplicationForm",
						data: data||{},
						computed:{
							request:function(){
								return GetRequest();
				...
				$.call("GetReplenishmentApplicationFormList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
