    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveCustomertype", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"Customertype.html?table=Customertype"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetCustomertypeEmpty", {}, function(data) {
					data = data||{};
				...
				$.call("GetCustomertypeList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
