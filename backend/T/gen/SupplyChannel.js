    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveSupplyChannel", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"SupplyChannel.html?table=SupplyChannel"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetSupplyChannelEmpty", {}, function(data) {
					data = data||{};
					data.table = 'SupplyChannel'
					vm = new Vue({
						el: "#SupplyChannel",
						data: data||{},
						computed:{
				...
				$.call("GetSupplyChannelList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
