    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveReplenishmentRecord", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"ReplenishmentRecord.html?table=ReplenishmentRecord"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetReplenishmentRecordEmpty", {}, function(data) {
					data = data||{};
					data.table = 'ReplenishmentRecord'
					vm = new Vue({
						el: "#ReplenishmentRecord",
						data: data||{},
						computed:{
							request:function(){
								return GetRequest();
				...
				$.call("GetReplenishmentRecordList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
