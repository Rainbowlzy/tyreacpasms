    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveTypeOfGoods", JSON.parse(JSON.stringify(datum)), function(data) {
			...
			back(){
				window.location.href = site_gen+"TypeOfGoods.html?table=TypeOfGoods"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetTypeOfGoodsEmpty", {}, function(data) {
					data = data||{};
					data.table = 'TypeOfGoods'
					vm = new Vue({
						el: "#TypeOfGoods",
						data: data||{},
						computed:{
				...
				$.call("GetTypeOfGoodsList", {SearchKey: request.id}, function(data) {
					if(!data){
						alert(data);
						return;
					}
