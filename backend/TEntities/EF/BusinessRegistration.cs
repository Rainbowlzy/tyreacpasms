...
public partial class BusinessRegistration
{
    ...
    public string BRServiceType { get; set; }
    public string BRApplicant { get; set; }
    public string BRIdNumber { get; set; }
    public string BRChairperson { get; set; }
    public Nullable<System.DateTime> BRHallAcceptanceTime { get; set; }
